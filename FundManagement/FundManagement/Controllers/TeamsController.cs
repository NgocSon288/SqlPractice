...
namespace FundManagement.Controllers
{
    ...
    [ApiController]
    public class TeamsController : BaseController<Team, int>
    {  
        public TeamsController(ILogger<TeamsController> logger, ITeamService teamService) : base(logger, teamService)
        { 
        }
    }
}
